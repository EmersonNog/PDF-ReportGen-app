...
class ItemScreenCivil extends StatefulWidget {
  final Item item;

  const ItemScreenCivil(this.item, {super.key});

  @override
  _ItemScreenCivilState createState() => _ItemScreenCivilState();
}

class _ItemScreenCivilState extends State<ItemScreenCivil> {
  ...
  final List<MultiSelectItem<String>> _descriptionItems = [
    ...
    MultiSelectItem(
        'C-04: MANCHAS DE UMIDADE NA ESTRUTURA DA COBERTURA', 'C-04'),
    ...
    MultiSelectItem(
        'A-03: DESCOLAMENTO DE REVESTIMENTO CERÂMICO NAS PAREDES', 'A-03'),
    MultiSelectItem('A-04: DESGASTE SUPERFICIAL DA ESTRUTURA', 'A-04'),
    MultiSelectItem(
        'A-05: DESPRENDIMENTO DA ARGAMASSA DE REVESTIMENTO', 'A-05'),
    ...
    MultiSelectItem(
        'I-04: DESCOLAMENTO DO REVESTIMENTO CERÂMICO DO PISO', 'I-04'),
    MultiSelectItem(
        'I-05: DESPLACAMENTO SUPERFICIAL DO PISO DE CONCRETO', 'I-05'),
    MultiSelectItem('I-06: DETERIORAÇÃO DO PISO DE CONCRETO', 'I-06'),
    MultiSelectItem(
        'I-07: DETERIORAÇÃO DO REJUNTE ENTRE PEÇAS CERÂMICAS', 'I-07'),
  ...
  Future<void> _savePhotos() async {
    ...
    await prefs.setString(
        '${widget.item.id}_civil_photosData', jsonEncode(photosData));
  }

  Future<void> _loadPhotos() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? photosDataJson =
        prefs.getString('${widget.item.id}_civil_photosData');
  ...
  Map<String, int> countDescriptionOccurrences(List<PhotoData> photoDataList) {
